    ...
    describe "Game Test Suite"
        [ describe "rotating piece"
            ...
            , describe "S"
                [ test "0 degree rotation" <|
                    \_ ->
                        Game.rotatePoints Game.Up Game.S
                            |> Expect.equalLists (Game.cellsForShape Game.S)
                , test "90 degree rotation" <|
                    \_ ->
                        Game.rotatePoints Game.Right Game.S
                            |> Expect.equalLists [ ( 0, 1 ), ( 0, 0 ), ( 1, 0 ), ( 1, -1 ) ]
                , test "180 degree rotation" <|
                    \_ ->
                        Game.rotatePoints Game.Down Game.S
                            |> Expect.equalLists [ ( 1, 0 ), ( 0, 0 ), ( 0, -1 ), ( -1, -1 ) ]
                , test "270 degree rotation" <|
                    \_ ->
                        Game.rotatePoints Game.Left Game.S
                            |> Expect.equalLists [ ( 0, -1 ), ( 0, 0 ), ( -1, 0 ), ( -1, 1 ) ]
                ]
            , describe "T"
                [ test "0 degree rotation" <|
                    \_ ->
                        Game.rotatePoints Game.Up Game.T
                            |> Expect.equalLists (Game.cellsForShape Game.T)
                , test "90 degree rotation" <|
                    \_ ->
                        Game.rotatePoints Game.Right Game.T
                            |> Expect.equalLists [ ( 0, 1 ), ( 0, 0 ), ( 1, 0 ), ( 0, -1 ) ]
                , test "180 degree rotation" <|
                    \_ ->
                        Game.rotatePoints Game.Down Game.T
                            |> Expect.equalLists [ ( 1, 0 ), ( 0, 0 ), ( 0, -1 ), ( -1, 0 ) ]
                , test "270 degree rotation" <|
                    \_ ->
                        Game.rotatePoints Game.Left Game.T
                            |> Expect.equalLists [ ( 0, -1 ), ( 0, 0 ), ( -1, 0 ), ( 0, 1 ) ]
                ]
            , describe "Z"
                [ test "0 degree rotation" <|
                    \_ ->
                        Game.rotatePoints Game.Up Game.Z
                            |> Expect.equalLists (Game.cellsForShape Game.Z)
                , test "90 degree rotation" <|
                    \_ ->
                        Game.rotatePoints Game.Right Game.Z
                            |> Expect.equalLists [ ( 1, 1 ), ( 1, 0 ), ( 0, 0 ), ( 0, -1 ) ]
                , test "180 degree rotation" <|
                    \_ ->
                        Game.rotatePoints Game.Down Game.Z
                            |> Expect.equalLists [ ( 1, -1 ), ( 0, -1 ), ( 0, 0 ), ( -1, 0 ) ]
                , test "270 degree rotation" <|
                    \_ ->
                        Game.rotatePoints Game.Left Game.Z
                            |> Expect.equalLists [ ( -1, -1 ), ( -1, 0 ), ( 0, 0 ), ( 0, 1 ) ]
                ]
            ]
        ]
